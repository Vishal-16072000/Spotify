    ...
    <>
        ...
        <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
            ...
            <div className='flex flex-col'>
                ...
                <div className='mt-1 flex gap-2 overflow-auto'>
                            <img className='inline-block h-6' src={assets.spotify_logo} alt=""/>
                            <b>Spotify</b>
                        <div className='ml-5 flex'>
                            <ul className='list-disc flex gap-6 overflow-auto'>
                                <li><b>1,323,154 likes</b></li>
                                <li><b>50 songs</b></li>
                            </ul>
                            <p className='font-semibold ml-4'>about 2 hr 30 min</p>
                        </div>
                </div>
            </div>
        </div>
