  ...
  return (
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className='hidden lg:flex items-center gap-1   opacity-75'>
        <img className='w-5 cursor-pointer'src={assets.plays_icon}/>
        <img className='w-4 cursor-pointer'src={assets.mic_icon}/>
        <img className='w-5 cursor-pointer'src={assets.queue_icon}/>
        <img className='w-4 cursor-pointer'src={assets.speaker_icon}/>
        <img className='w-4 cursor-pointer'src={assets.volume_icon}/>
        <div className='w-12 bg-slate-100 rounded-full'>
          <hr className='h-1 rounded-full bg-orange-600 w-0 border-none'/>
        </div>
        <img className='w-5 cursor-pointer'src={assets.mini_player_icon}/>
